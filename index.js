...
//Download Archived Repos
rp.get('https://www.gitlab.com/api/v4/groups\?archived\=true&per_page=100', {
  json: true,
  qs: {
    simple: true,
  },
  ...
  for (let gid of gids) {
    promises.push(
      rp.get(`https://www.gitlab.com/api/v4/groups/${gid}/projects\?archived\=true&per_page=100`, {
        json: true,
        qs: {
          simple: true,
        },
